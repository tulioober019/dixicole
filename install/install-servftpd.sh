...
REGRAS[8,cadea]="INPUT" &&  REGRAS[8,interface]="eth0" && REGRAS[8,protocolo]="tcp" && REGRAS[8,porto_orixe]="any" && REGRAS[8,porto_destino]="21"  && REGRAS[8,accion]="ACCEPT"
REGRAS[9,cadea]="OUTPUT" && REGRAS[9,interface]="eth0" && REGRAS[8,protocolo]="tcp" && REGRAS[9,porto_orixe]="21"  && REGRAS[9,porto_destino]="any" && REGRAS[9,accion]="ACCEPT"

REGRAS[10,cadea]="INPUT" &&  REGRAS[10,interface]="eth0" && REGRAS[10,protocolo]="tcp" && REGRAS[10,porto_orixe]="any" && REGRAS[10,porto_destino]="20"  && REGRAS[10,accion]="ACCEPT"
REGRAS[11,cadea]="OUTPUT" && REGRAS[11,interface]="eth0" && REGRAS[11,protocolo]="tcp" && REGRAS[11,porto_orixe]="20"  && REGRAS[11,porto_destino]="any" && REGRAS[11,accion]="ACCEPT"
