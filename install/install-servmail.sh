...
REGRAS[8,cadea]="INPUT" &&  REGRAS[8,interface]="eth0" && REGRAS[8,protocolo]="tcp" && REGRAS[8,porto_orixe]="any" && REGRAS[8,porto_destino]="25"  && REGRAS[8,accion]="ACCEPT"
REGRAS[9,cadea]="OUTPUT" && REGRAS[9,interface]="eth0" && REGRAS[8,protocolo]="tcp" && REGRAS[9,porto_orixe]="25"  && REGRAS[9,porto_destino]="any" && REGRAS[9,accion]="ACCEPT"

REGRAS[10,cadea]="INPUT" &&  REGRAS[10,interface]="eth0" && REGRAS[10,protocolo]="tcp" && REGRAS[10,porto_orixe]="any" && REGRAS[10,porto_destino]="143" && REGRAS[10,accion]="ACCEPT"
REGRAS[11,cadea]="OUTPUT" && REGRAS[11,interface]="eth0" && REGRAS[11,protocolo]="tcp" && REGRAS[11,porto_orixe]="143" && REGRAS[11,porto_destino]="any" && REGRAS[11,accion]="ACCEPT"

REGRAS[12,cadea]="INPUT" &&  REGRAS[12,interface]="eth0" && REGRAS[12,protocolo]="tcp" && REGRAS[12,porto_orixe]="22"  && REGRAS[12,porto_destino]="any" && REGRAS[12,accion]="ACCEPT"
REGRAS[13,cadea]="OUTPUT" && REGRAS[13,interface]="eth0" && REGRAS[13,protocolo]="tcp" && REGRAS[13,porto_orixe]="any" && REGRAS[13,porto_destino]="22"  && REGRAS[13,accion]="ACCEPT"

# Conexións dns
REGRAS[14,cadea]="INPUT" &&  REGRAS[14,interface]="eth0" && REGRAS[14,protocolo]="udp" && REGRAS[14,porto_orixe]="53"  && REGRAS[14,porto_destino]="any" && REGRAS[14,accion]="ACCEPT"
REGRAS[15,cadea]="OUTPUT" && REGRAS[15,interface]="eth0" && REGRAS[15,protocolo]="udp" && REGRAS[15,porto_orixe]="any" && REGRAS[15,porto_destino]="53"  && REGRAS[15,accion]="ACCEPT"

# Conexións dhcp
REGRAS[16,cadea]="INPUT" &&  REGRAS[16,interface]="eth0" && REGRAS[16,protocolo]="udp" && REGRAS[16,porto_orixe]="67"  && REGRAS[16,porto_destino]="any" && REGRAS[16,accion]="ACCEPT"
REGRAS[17,cadea]="OUTPUT" && REGRAS[17,interface]="eth0" && REGRAS[17,protocolo]="udp" && REGRAS[17,porto_orixe]="any" && REGRAS[17,porto_destino]="67"  && REGRAS[17,accion]="ACCEPT"

REGRAS[18,cadea]="INPUT" &&  REGRAS[18,interface]="eth0" && REGRAS[18,protocolo]="udp" && REGRAS[18,porto_orixe]="any" && REGRAS[18,porto_destino]="68"  && REGRAS[18,accion]="ACCEPT"
REGRAS[19,cadea]="OUTPUT" && REGRAS[19,interface]="eth0" && REGRAS[19,protocolo]="udp" && REGRAS[19,porto_orixe]="67"  && REGRAS[19,porto_destino]="any" && REGRAS[19,accion]="ACCEPT"
